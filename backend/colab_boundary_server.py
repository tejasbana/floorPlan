...
def upload():
    if request.method == 'POST' :
        ...
        if True:#'photo' in request.files:
            ...
            latent_dim = 128
            # save from url 
            response = requests.get("https://storage.googleapis.com/housegan-3f845.appspot.com/floorplan/plan0.jpg")
            img = Image.open(BytesIO(response.content)).convert("RGB")
            file_name = "From_URL" + ".jpg"
            ...
            return render_template('upload.html', img_path=encoded_img)
